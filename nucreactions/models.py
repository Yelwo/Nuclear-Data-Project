...
class Reaction(models.Model):
    ...
    _product_three = models.ForeignKey(ReactionsField, on_delete=models.CASCADE, related_name='product_three', null=True)
    ...
    def germ(self):
        ...
        left  = reduce(lambda x, y: myAdd(x, myMultiply(y.quantity, y.field_content.germ)), self.left_right[0], (0, 0))
        right = reduce(lambda x, y: myAdd(x, myMultiply(y.quantity, y.field_content.germ)), self.left_right[1], (0, 0))
    ...
    def germ_shell_view(self):
        ...
        sum_of_items = [shell_occupation(self._target), shell_occupation(self._projectile), myMultiply(-1, self.germ)]
